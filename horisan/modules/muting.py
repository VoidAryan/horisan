...
def check_user(user_id: int, bot: Bot, chat: Chat) -> Optional[str]:
    ...
    if not user_id:
        reply = "⚠️ User not found! baka is dumb or what"
        return reply
    ...
    try:
        ...
        if excp.message == "User not found ree! check again":
            reply = "I can't seem to find this user! want me to find dinosaur"
            return reply
        raise

    if user_id == bot.id:
        reply = (
            "I cant mute mmyself! but what happened! tell @voidxtoxic he will fix naa"
        )
        return reply
...
def mute(update: Update, context: CallbackContext) -> str:
    ...
    if member.can_send_messages is None or member.can_send_messages:
        ...
        return log
    message.reply_text("Hori San Already muted that user hehe")
...
def unmute(update: Update, context: CallbackContext) -> str:
    ...
    if not user_id:
        message.reply_text(
            "You'll need to either give me a username to unmute, or reply to someone to be unmuted. cuz baka i cant read your mind!"
        )
        return ""
    ...
    if member.status in ("kicked", "left"):
        message.reply_text(
            ...
            "already do! listen to your hori san baka!",
        )
        ...
        message.reply_text(
            "This user already has the right to speak. Now want me to tag and say to chat?"
        )
    else:
        ...
        bot.sendMessage(
            chat.id,
            "{} [<code>{}</code>] Was 🔊 Unmuted hehe.".format(
...
def temp_mute(update: Update, context: CallbackContext) -> str:
    ...
    if not reason:
        message.reply_text("Baka You haven't specified a time to mute this user for!")
        return ""
