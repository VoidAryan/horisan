...
@horicmd(command="raid", pass_args=True)
@bot_admin
@connection_status
@loggable
...
@horicallback(pattern="enable_raid=")
@connection_status
@user_admin_no_reply
@loggable
...
@horicallback(pattern="disable_raid=")
@connection_status
@user_admin_no_reply
@loggable
...
@horicallback(pattern="cancel_raid=")
@connection_status
@user_admin_no_reply
...
@horicmd(command="raidactiontime", pass_args=True)
@connection_status
@user_admin(AdminPerms.CAN_CHANGE_INFO)
@loggable
def raidtime(update: Update, context: CallbackContext) -> Optional[str]:
