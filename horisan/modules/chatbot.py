...
async def hmm(client, message):
    ...
    if chat_id in en_chats:
        ...
        test = test.replace("Hori Kyouko", "Voidxtoxic")
        test = test.replace("My god is @voidxtoxic", "I'm an anime based groubot.")
        test = test.replace("16", "9")
        test = test.replace("@voidxtoxic is my husband.", "I'm single.")
        test = test.replace("My husband is @voidxtoxic, "I'm single.")
        ...
        response = response.replace("I'm a Christian", "My god is @voidxtoxic")
        response = response.replace("9", "16")
        response = response.replace("I'm married to my job.", "I'm married with @voidxtoxic")
        response = response.replace("I'm single.", "My husband is @voidxtoxic")
        ...
        test = test.replace("Hori Kyouko", "Xhate")
        test = test.replace("My god is @voidxtoxic", "I'm a Christian")
        test = test.replace("16", "9")
        test = test.replace("@voidxtoxic is my husband.", "I'm single.")
        test = test.replace("@horixsupport", "Hori Kyoukobot.ai")
        test = test.replace("I live in @horixsupport.", "I live in San Francisco, California")
...
async def inuka(client, message):
    ...
    test = test.replace("My god is @voidxtoxi", "I'm a Christian")
    test = test.replace("16", "9")
    test = test.replace("@voidxtoxic is my husband.", "I'm single.")
    test = test.replace("@horixsupport", "Hori Kyoukobot.ai")
    test = test.replace("I live in @horixsupport.", "I live in San Francisco, California.")
