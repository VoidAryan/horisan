...
def afk(update, context):
    ...
    horisan = update.message.reply_video("https://telegra.ph/file/0f024fd6efa00caf090ea.mp4", caption ="Baii Baii {} 👋".format(update.effective_message.from.user_name), parse_mode=ParseMode.MARKDOWN)
        time.sleep(50)
        try:
            horisan.delete()
        except BadRequest:
...
def __stats__():
    return f"۞ {len(REDIS.keys())} ᴛᴏᴛᴀʟ ᴋᴇʏꜱ ɪɴ ᴅᴀᴛᴀʙᴀꜱᴇ\n"
