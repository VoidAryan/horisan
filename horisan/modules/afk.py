...
from horisan import telethn as Horisan
...
SAFK_HANDLER = DisableAbleCommandHandler( "safk", safk,  run_async=True)
AFK_REGEX_HANDLER = CommandHandler(Filters.regex("(?i)safk", safk))
