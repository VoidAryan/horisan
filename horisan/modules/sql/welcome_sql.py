...
DEFAULT_WELCOME_MESSAGES = [
    "Welcome {first}! Hori Declare You Baka",  # Written By VOID
    "Hey {first} Welcome In Our GroupChat 👋",
    "{first} Joined now Group will be dead",
    "{first} Joined ✌",
]
DEFAULT_GOODBYE_MESSAGES = [
    "{first} Left...",
    "Dont Worry {first} Left...Chat Will Be Peaceful !",
]
# WRITTEN BY VOID NOT COPIED
