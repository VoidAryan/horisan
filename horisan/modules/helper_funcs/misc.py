...
from horisan import NO_LOAD
from telegram import MAX_MESSAGE_LENGTH, Bot, InlineKeyboardButton, InlineKeyboardMarkup, ParseMode, InputTextMessageContent, InlineQueryResultArticle
...
def paginate_modules(page_n: int, module_dict: Dict, prefix, chat=None) -> List:
    ...
    if len(pairs) > 3:
        pairs = pairs[modulo_page * 7:9 * (modulo_page + 1)] + [
            (EqInlineKeyboardButton("🔹ᴘʀᴇᴠɪᴏᴜꜱ🔹", callback_data="{}_prev({})".format(prefix, modulo_page)),
                EqInlineKeyboardButton("🔸BACK🔸",  callback_data="hori_back"),
